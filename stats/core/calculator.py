...
class ProbabilityCalculator(ABC):
    ...
    def __init__(self, config: Optional[BannerConfig] = None):
        ...
        self.p_first_5_star: List[
            float
        ] = []  # Probability of getting the first 5-star on a specific roll
        self.cumulative_prob: List[
            float
        ] = []  # Cumulative probability of getting a 5-star by a specific roll
